...
jest.mock('../middleware/roles', () => {
    return {
        admin: jest.fn((req: Request, res: Response, next: NextFunction) =>
            next()
        ),
        volunteer: jest.fn((req: Request, res: Response, next: NextFunction) =>
            next()
        ),
        client: jest.fn((req: Request, res: Response, next: NextFunction) =>
            next()
        ),
    };
});
