      ...
      */}
      ...
      <div id="mainComps">
        <div id="admvol">
          ...
          <div style={{width: "fit-content", height:"fit-content", float:"left", margin:"auto", marginBottom: "15%", marginRight:"20px"}}>
        ...
        <div style={{height:"fit-content", width:"100%", float:"left"}}>
          <div id="image">
            <Image src={image1} alt="image" width={239} height={239} />
          </div>
        </div>
        ...
        {selectedOption === "volLogInConfirm" && (
          <div>
            <div style={{margin: 'auto', height:"fit-content", width:"100%", float:"left", marginTop:"50px", textAlign:"center"}}>
                Enter the code sent to your email
                <div style={{width:'1%', marginTop:'4%', marginBottom:'4%'}}>
                  <CodeInput/>
                </div>
            </div>
            <div id="logButton">
