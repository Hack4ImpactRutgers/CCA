...
function Assessment(props: AssessmentProps) {
    ...
    return (
        <form className="">
            ...
            <div className="mr-10">
                If not, let’s work with the client to learn why. For example,
                providing a measuring cup for the pet food and weighing the pet
                could be helpful:
            </div>

            <div className="flex">
                <Checkbox checked={props.cup} handleChange={handleCupChange} />
                <div className="ml-1">Measuring Cup</div>
                <div className="ml-5">
                    <Checkbox
                        checked={props.scale}
                ...
                <div className="ml-1">Pet Scale</div>
            </div>
            ...
            <div className='mt-5 after:ml-0.5 after:text-[red] after:content-["*"]'>
                Does the client need any other supplies (collars, leashes,
                bowls, etc)?
            </div>
            <TextInput
                value={props.supplies || ''}
                placeholder={''}
                onChange={props.setSupplies}
            />

            <div className='mt-5 after:ml-0.5 after:text-[red] after:content-["*"]'>
                Are there any other pet related needs at this time (vet
                visit/medication)?
            </div>
            <TextInput
                value={props.needs || ''}
                placeholder={''}
                onChange={props.setNeeds}
            />

            <div
                onClick={() => props.setFormPage('Submit')}
