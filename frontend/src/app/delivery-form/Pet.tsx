...
function Pet(props: PetProps) {
    return (
        <form className="">
            <div className="mt-5">Pet Name</div>
            <TextInput
                value={props.petName || ''}
                placeholder={''}
            ...
            <div className="mt-5 ">Type of Food</div>
            <TextInput
                value={props.foodType || ''}
                placeholder={''}
                onChange={props.setFoodType}
            />

            <div className="mt-5 ">Amount of Food Per Month</div>

            <TextInput
                value={props.foodAmount || ''}
                placeholder={''}
                onChange={props.setFoodAmount}
            />
            <div className="flex flex-row">
                {
                    <div
                        onClick={() => props.setFormPage('Assessment')}
                        className="mt-5"
                    >
