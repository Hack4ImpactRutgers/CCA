  ...
  return (
    <form className="flex flex-col">
      ...
      <div className="flex flex-row">
        <Checkbox checked={props.litter} handleChange={handleLitterChange} />
        <div className='ml-3'>
          Pet litter/pads
        </div>
      </div>
      ...
      <div className="flex flex-row">
        <Checkbox checked={props.supplies} handleChange={handleSupplyChange} />
        <div className='ml-3'>
      ...
      <div className="flex flex-row">
        <Checkbox checked={props.petMedication} handleChange={handlePetMedicationChange} />
        <div className='ml-3'>
          Pet medication
        </div>
      </div>
      ...
      <div className="flex flex-row">
        <Checkbox checked={props.vetServices} handleChange={handleVetServicesChange} />
        <div className='ml-3'>
          Veterinary services
        </div>
      </div>
      ...
      <div className="flex flex-row">
        <Checkbox checked={props.petTransport} handleChange={handlePetTransportChange} />
        <div className='ml-3'>
          Pet transportation for vet visits
        </div>
      </div>

      <div className="flex flex-row">
        <Checkbox checked={props.petWalking} handleChange={handlePetWalkingChange} />
        <div className='ml-3'>
          Pet walking
        </div>
      </div>
      ...
      <div className="flex flex-row">
        <Checkbox checked={props.boarding} handleChange={handleBoardingChange} />
        <div className='ml-3'>
      ...
      <div className="flex flex-row">
        <Checkbox checked={props.other} handleChange={handleOtherChange} />
        <div className='ml-3'>
          Other
        </div>
      </div>
